...
/// The wrapper for the event handle returned from CreateMutex() method.
typedef ScopedHandle<HANDLE, NullHandleValue<HANDLE>, CloseHandleMethod> MutexScopedHandle;
